# -*- coding: utf-8 -*-
"""official_pici_typer.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1L_-AMHYE9Qeujy52mifFpkeolfzGfQD2
"""
...
for m in range(len(seq_list)):
  PICI_file.write(">" + str(name_list[m]).split("||")[0] + " " + str(PICI_type[m]) + "_" + str(m) + "\n" + str(seq_list[m]) + "\n")
